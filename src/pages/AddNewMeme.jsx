...
export function AddNewMeme() {
  ...
  const submitNewMeme = () => {
    if (userUrl.length > 0) {
      dispatch({
        type: "SUBMIT_MEME",
        payload: { src: userUrl, title: userTitle, tags: userTags },
      });
  ...
  return (
    ...
    >
      <PageBase marginTop={6}>
        <Typography
          variant="h5"
          sx={{ fontSize: 34, color: "primary.main", marginBottom: 3 }}
        >
          HERE YOU CAN ADD YOUR MEME
        </Typography>
        <TextField
          label="Add URL"
        ...
        />
        <Typography sx={{ color: "primary.main", marginBottom: 1 }}>
          You can add max. 5 tags (type or choose from the list)
        </Typography>
        <Autocomplete
          value={userTags}
        ...
        <Button
          ...
          variant="contained"
          sx={{ margin: 0.5, boxShadow: 1, width: "300px" }}
        >
          SUBMIT
        </Button>
      </PageBase>
